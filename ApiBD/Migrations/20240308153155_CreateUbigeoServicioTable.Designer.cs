...
namespace ApiBD.Migrations
{
    ...
    [Migration("20240308153155_CreateUbigeoServicioTable")]
    partial class CreateUbigeoServicioTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiBD.Models.TbConfUbigeoServicio", b =>
                {
                    b.Property<string>("CodUbi")
                        .HasMaxLength(6)
                        .HasColumnType("varchar(6)")
                    ...
                    b.HasKey("CodUbi", "IdServicio")
                        .HasName("PRIMARY");

                    b.HasIndex("IdServicio");

                    b.ToTable("tb_conf_ubigeo_servicio", (string)null);
            ...
            modelBuilder.Entity("ApiBD.Models.TbConfUbigeoServicio", b =>
                {
                    b.HasOne("ApiBD.Models.TbConfUbigeo", "TbConfUbigeo")
                        .WithMany("TbConfUbigeoServicios")
                        .HasForeignKey("CodUbi")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("tb_conf_ubigeo_servicio_ibfk_1");

                    b.HasOne("ApiBD.Models.TbServCabecera", "TbServCabecera")
                        .WithMany("TbConfUbigeoServicios")
                        .HasForeignKey("IdServicio")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("tb_conf_ubigeo_servicio_ibfk_2");

                    b.Navigation("TbConfUbigeo");

                    b.Navigation("TbServCabecera");
                });
            ...
            modelBuilder.Entity("ApiBD.Models.TbConfUbigeo", b =>
                {
                    b.Navigation("TbConfUbigeoServicios");
                });
