...
namespace Cms.ServiceCms
{
    public class SlideCmsService
    {
        ...
        {
            var url = "https://localhost:7260/api/slide"; // Reemplaza con la URL correcta de tu API
        ...
        {
            var url = $"https://localhost:7260/api/slide/{id}"; // Reemplaza con la URL correcta de tu API
